...
public final class BookmarksFragment extends CusNewsFragment {
	...
	public void onEvent(BookmarksInitEvent e) {
		mBinding.setBookmarksAdapter(new BookmarksAdapter(Prefs.getInstance().getViewType(), BookmarksManager.getInstance().getCachedBookmarks()));
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		switch (vt) {
		case GRID:
			mBinding.bookmarksRv.setLayoutManager( new GridLayoutManager(getActivity(),
					MainActivity.GRID_SPAN));
			break;
		default:
