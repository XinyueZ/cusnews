 ...
 */
public class CheckBoxFontTextView extends CheckedTextView {
	public CheckBoxFontTextView( Context context ) {
		super( context );
	}

	public CheckBoxFontTextView( Context context, AttributeSet attrs ) {
		super( context, attrs );
		initialize( context, attrs );
	}

	public CheckBoxFontTextView( Context context, AttributeSet attrs, int defStyle ) {
